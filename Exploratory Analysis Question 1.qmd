...
gridExtra::grid.arrange(plot.fruit + theme(legend.position="none"), 
...
gridExtra::grid.arrange(plot.year + theme(legend.position="none"),
...
gridExtra::grid.arrange(plot.age1 + theme(legend.position="none"),
...
```{r}
#| label: tbl-diff-mod-evals
#| tbl-cap: Confusion matrix and predictive performance metrics for our model at a threshold of 0.269
#| tbl-cap-location: top
#| message: false
#| layout-ncol: 2

#Can't get these plots to render side-by-side 
