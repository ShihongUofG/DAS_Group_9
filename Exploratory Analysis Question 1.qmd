...
table_CM <- conf_mat(model_pred_0.269, 
         truth = Obese, 
...
table_EM <- eval_metric(model_pred_0.269,
            truth = Obese,
...
CMpng <- cowplot::ggdraw() + cowplot::draw_image("table_CM.png", scale = 0.4)
EMpng <- cowplot::ggdraw() + cowplot::draw_image("table_EM.png", scale = 0.3)

cowplot::plot_grid(CMpng, EMpng, nrow = 1)
