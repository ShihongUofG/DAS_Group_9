...
We want to see whether initial plots may give an indication to if there is in fact a difference in obesity levels across the other variables in the survey. We will begin by looking at fruit and veg intake to see if there are differences in these areas.We will also look at variables 'sex' and 'year' to check the differences.
...
We can see here that the proportions of obesity appear to be almost in the same in fruit in take, although there may be a slight difference in whether a person consumes vegetables. Next lets look at differences across years and sex.
